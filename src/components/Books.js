          ...
          {books.map((book, index) => (
            <div key={index} className="book-container">
              ...
              <section className='modify'>
                ...
                <button style={{ float:'right',marginRight:'5px',display: 'flex', alignItems: 'center',justifyContent: 'center',padding:'2.3px',color: 'white',cursor: 'pointer',transition: 'color 0.3s ease',fontSize: '0.8rem',border: '1px solid black',borderRadius:'50%',backgroundColor:'red' }} onClick={openBlock}><FontAwesomeIcon icon={faPen} className='' /></button>
                <button style={{ float:'right' , marginRight:'5px',display: 'flex', alignItems: 'center',justifyContent: 'center',padding:'2.4px',color: 'white',cursor: 'pointer',transition: 'color 0.3s ease',fontSize: '0.8rem',border: '1px solid black',borderRadius:'50%',backgroundColor:'red'}}><FontAwesomeIcon icon={faTrash} className=''  /></button>
              </section>
            </div>
